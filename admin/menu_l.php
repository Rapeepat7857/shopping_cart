 <aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li>
        <a href="stock.php"><i class="glyphicon glyphicon-record"></i>
          <span> จัดการวัตถุดิบ </span>
        </a>
      </li>
      <li>
        <a href="poits.php"><i class="glyphicon glyphicon-record"></i>
          <span> จัดการคะแนน </span>
        </a>
      </li>
      <li>
        <a href="reward.php"><i class="glyphicon glyphicon-record"></i>
